...
if dataset == 'recs20':
    ...
    #Alaska
    #(1)yes
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 1) & (df['MONEYPY'] <= 8 ), 'WAP'] = 1 #(calc. $32,180) less then $30,000
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 2) & (df['MONEYPY'] <= 10 ), 'WAP'] = 1 #(calc. $43,540) less then $40,000
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 3) & (df['MONEYPY'] <= 11 ), 'WAP'] = 1 #(calc. $54,900) less then $50,000
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 4) & (df['MONEYPY'] <= 12 ), 'WAP'] = 1 #(calc. $66,260) less then $60,000
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 5) & (df['MONEYPY'] <= 13 ), 'WAP'] = 1 #(calc. $77,620) less then $75,000
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 6) & (df['MONEYPY'] <= 13 ), 'WAP'] = 1 #(calc. $88,980) less then $75,000
    df.loc[(df['STATE_FIPS'] == 2 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 7) & (df['MONEYPY'] <= 14 ), 'WAP'] = 1 #(calc. $100,340) less then $100,000
    #Hawaii
    #(1)yes
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 1) & (df['MONEYPY'] <= 8 ), 'WAP'] = 1 #(calc. $29,640) less then $30,000
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 2) & (df['MONEYPY'] <= 10 ), 'WAP'] = 1 #(calc. $40,080) less then $40,000
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 3) & (df['MONEYPY'] <= 11 ), 'WAP'] = 1 #(calc. $50,520) less then $50,000
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 4) & (df['MONEYPY'] <= 12 ), 'WAP'] = 1 #(calc. $60,960) less then $60,000
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 5) & (df['MONEYPY'] <= 12 ), 'WAP'] = 1 #(calc. $71,400) less then $60,000
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 6) & (df['MONEYPY'] <= 13 ), 'WAP'] = 1 #(calc. $81,840) less then $75,000
    df.loc[(df['STATE_FIPS'] == 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 7) & (df['MONEYPY'] <= 13 ), 'WAP'] = 1 #(calc. $92,280) less then $75,000
    #Cont 48
    #(1)yes
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 1) & (df['MONEYPY'] <= 7 ), 'WAP'] = 1 #(calc. $25,760) less then $25,000
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 2) & (df['MONEYPY'] <= 9 ), 'WAP'] = 1 #(calc. $34,840) less then $35,000
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 3) & (df['MONEYPY'] <= 10 ), 'WAP'] = 1 #(calc. $43,920) less then $40,000
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 4) & (df['MONEYPY'] <= 11 ), 'WAP'] = 1 #(calc. $53,000) less then $50,000
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 5) & (df['MONEYPY'] <= 12 ), 'WAP'] = 1 #(calc. $62,080) less then $60,000
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 6) & (df['MONEYPY'] <= 13 ), 'WAP'] = 1 #(calc. $71,160) less then $75,000
    df.loc[(df['STATE_FIPS'] != 2 ) & (df['STATE_FIPS'] != 15 ) & (df['KOWNRENT'] == 1) & (df['NHSLDMEM'] == 7) & (df['MONEYPY'] <= 13 ), 'WAP'] = 1 #(calc. $80,240) less then $75,000
    #fill WAP nan
    #(2) no
    df['WAP'] = df['WAP'].fillna(2)
    ...
    #WAP
    #(1)yes
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 1) & (df['HINCP'] <= 12880*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 2) & (df['HINCP'] <= 17420*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 3) & (df['HINCP'] <= 21960*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 4) & (df['HINCP'] <= 26500*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 5) & (df['HINCP'] <= 31040*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 6) & (df['HINCP'] <= 35580*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 7) & (df['HINCP'] <= 40120*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 8) & (df['HINCP'] <= 44660*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 9) & (df['HINCP'] <= (44660+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 10) & (df['HINCP'] <= (44660+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 11) & (df['HINCP'] <= (44660+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 12) & (df['HINCP'] <= (44660+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 13) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 14) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 15) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 16) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 17) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 18) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    df.loc[(df['TENURE'] == '1') & (df['NUMPEOPLE'] == 19) & (df['HINCP'] <= (44660+4540+4540+4540+4540+4540+4540+4540+4540+4540+4540+4540)*2 ), 'WAP'] = 1
    #fill WAP nan
    #(2) no
    df['WAP'] = df['WAP'].fillna(2)
    
#%%df.groupby(['WAP']).agg({'weight':['sum']})