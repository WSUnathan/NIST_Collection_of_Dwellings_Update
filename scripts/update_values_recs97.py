...
if dataset == 'recs20':
    ...
    df = pd.read_csv("./recs_data/2020/RECS2020_NIST.csv") #USER ENTERED FINAL PATH FOR REC
...
apartment_characteristic.to_csv("1997_" + dataset + "_apartment_characteristics.csv", index=False)
attached_characteristic.to_csv("1997_" + dataset + "_attached_characteristics.csv", index=False)
detached_characteristic.to_csv("1997_" + dataset + "_detached_characteristics.csv", index=False)
mobile_home_characteristic.to_csv("1997_" + dataset + "_mobile_home_characteristics.csv", index=False)
